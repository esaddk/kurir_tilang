  ...
  <div class="card">
    ...
    <div class="card-body">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{ route('SubmitValidasi',$order->id) }}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input id="biaya_kirim" type="number" class="form-control @error('biaya_kirim') is-invalid @enderror" name="biaya_kirim"  required autocomplete="penerima" > 
                </div>  
                <div class="form-group">
                        <label for="">Foto Berkas Tilang</label>                        
                        @if (!empty($order->foto))            
                            <img class="img-fluid pad" src="{{ asset('uploads/foto_surat/' . $order->foto) }}" alt="Photo">
                       @endif
                </div>
                <div class="form-group">
                        <label>Konfirmasi Validasi Data</label>
                        <select name="status_data" id="status_data" class="form-control">
                          <option value="unvalid">Data Tidak Sesuai</option>
                          <option value="valid">Data Sesuai</option>                         
                        </select>
                      </div>
              </div>
