...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Validasi Data Transfer Admin</h3>
    ...
    <div class="card-body">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{ route('SubmitValidTransfer',$order->id) }}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                ...
                <div class="form-group">
                        ...
                        @if (!empty($order->foto_transfer))            
                            <img class="img-fluid pad" src="{{ asset('uploads/foto_transfer/' . $order->foto_transfer) }}" alt="Photo">
                       @endif
                </div>
                <div class="form-group">
                        <label>Konfirmasi Validasi Tranfer</label>
                        <select name="status_pembayaran" id="status_pembayaran" class="form-control">
                          <option value="unpaid">Pembayaran Belum Diterima</option>
                          <option value="paid">Pembayaran Sudah Diterima</option>                         
                        </select>
                      </div>
              </div>
